...
<recipetype:mekanism:oxidizing>.addRecipe("oxidize_ender_pearl", <item:minecraft:ender_pearl>, <gas:crafttweaker:end_essence>* 10);
<recipetype:mekanism:oxidizing>.addRecipe("oxidize_end_shard", <item:unusualend:ancient_shard>, <gas:crafttweaker:end_essence> * 640);
<recipetype:mekanism:crystallizing>.addRecipe("end_shard_from_gas", <gas:crafttweaker:end_essence> * 640, <item:unusualend:ancient_shard>);
